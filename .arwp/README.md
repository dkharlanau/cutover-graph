...
Audience: Cutover managers and engineers reviewing enterprise go-live evidence. Useful action: Inspect the generated control-room demo and run a synthetic cutover readiness check.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/cutover-graph/
...
Compare a status spreadsheet and a dependency-aware cutover control room on the same blocked synthetic task.
